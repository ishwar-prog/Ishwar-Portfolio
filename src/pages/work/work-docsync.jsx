...
import docsyncMain from "../../assets/docsync.png";
import docsync1 from "../../assets/docsync-1.png";
import docsync2 from "../../assets/docsync-2.png";
import docsync3 from "../../assets/docsync-3.png";
...
export default function WorkDocsync() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
    ...
    <main className="min-h-screen w-full overflow-hidden text-[#f6f4f0]">
      ...
      <section className="pb-10 md:pb-16 px-3 md:px-0 max-w-368 mx-auto">
        <CardCurtainReveal className="w-full rounded-[40px]">
          ...
          <CardCurtainRevealFooter>
            ...
            <a
              href="https://ishwar-prog.github.io/docsync-landing"
              target="_blank"
              rel="noopener noreferrer"
              className="w-14 h-14 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/35 hover:scale-110 transition-all duration-200 text-white"
            >
      ...
      <section className="pb-10 md:pb-16 px-3 md:px-0 max-w-368 mx-auto">
        ...
        <h2 className="text-lg sm:text-xl md:text-2xl lg:text-4xl font-bold leading-tight lowercase max-w-max">
          AI coding agents ship code far faster than documentation can be written. This npm package acts as an intelligent companion that monitors your codebase to detect when your documentation starts to drift from your code. 
<br />
<br />
By parsing changed files and analyzing the structural differences, the system compares everything against a baseline. If the detected drift exceeds a set threshold, it immediately uses AI to generate precise documentation updates and automatically opens a pull request. It effectively removes the headache of outdated references and ensures your documentation stays as current as your codebase.
        </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-10 md:gap-60 mt-8 md:mt-13 text-sm md:text-base">
          <div>
            ...
            <p className="font-semibold text-base sm:text-lg md:text-2xl lowercase">developer tool / npm package</p>
          </div>
          <div>
            <p className="text-white/65 lowercase mb-1 font-semibold text-sm md:text-xl">year</p>
            <p className="font-semibold text-base sm:text-lg md:text-2xl lowercase">5/26</p>
          </div>
          <div>
            <p className="text-white/65 lowercase mb-1 font-semibold text-sm md:text-xl">role</p>
            <p className="font-semibold text-base sm:text-lg md:text-2xl lowercase">tool creator</p>
          </div>
          <div>
            <p className="text-white/65 lowercase mb-1 font-semibold text-sm md:text-xl">client</p>
            <p className="font-semibold text-base sm:text-lg md:text-2xl lowercase">open source</p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-12 md:pb-20 px-3 md:px-0 max-w-368 mx-auto">
        <ImageGallery
          images={[
            { title: "docsync screenshot 1", url: docsync1 },
            { title: "docsync screenshot 2", url: docsync2 },
            { title: "docsync screenshot 3", url: docsync3 },
          ]}
        />
      </section>
