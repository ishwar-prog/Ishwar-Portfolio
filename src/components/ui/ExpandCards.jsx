                    ...
                    <div className="flex gap-2" onClick={(e) => e.preventDefault()}>
                      {"github" in project && (
                        <a
                          ...
                          className="bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/40 hover:scale-110 transition-all duration-200 text-white"
                          style={{ width: "3.25rem", height: "3.25rem", minWidth: "3.25rem" }}
                        >
                          <GithubIcon />
                        </a>
                      )}
